...
class CartController {
     ...
     * @returns A Promise that resolves to `true` if the cart was successfully checked out. -> in API.md reponse body content is none -> change to Promise<void>
     * 
     */
    ...
    async getCustomerCarts(user: User) :Promise<Cart[]> {
        return this.dao.getCartHistory(user);
    }
     ...
     * @returns A Promise that resolves to `true` if all carts were successfully deleted.  -> in API.md reponse body content is none -> change to Promise<void>
     */
