...
const USER_IS_ADMIN_2 = "Admins cannot be modified"
...
class UserIsAdmin2Error extends Error {
    customMessage: String;
    customCode: Number;

    constructor() {
        super()
        this.customMessage = USER_IS_ADMIN_2
        this.customCode = 401
    }
}
...
export { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UserIsAdmin2Error, UnauthorizedUserError }